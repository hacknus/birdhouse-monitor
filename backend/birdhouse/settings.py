...
DATABASES = {
    "default": {
        ...
        "NAME": os.path.join(BASE_DIR, "birdhouse.sqlite3"),
    }
}
...
MIDDLEWARE.append("mainapp.middleware.TrackVisitorMiddleware")