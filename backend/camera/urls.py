...
from .views import camera_home, capture_image, toggle_ir, stream_mjpg, stop_camera, get_gallery, start_stream

app_name = 'camera'  # Add this line to define the app's namespace

urlpatterns = [
    path("", camera_home, name="camera_home"),  # <-- Add this line
    path('camera/start_stream/', start_stream, name='start_stream'),
